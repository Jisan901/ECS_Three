...
function genChunkForLOD( center , lod,i){
    ...
    for ( let iy = 0; iy < gridY1; iy ++ ) {
        ...
        for ( let ix = 0; ix < gridX1; ix ++ ) {
            ...
            vertices.push(x,Math.min(7,5*cnoise([(center.x+x)*0.1,(center.z+y)*0.1])),y)
    ...
    fs.writeFileSync(`Data/heightData${lod}-${center.x}x${center.z}.json`, JSON.stringify({vertices, indices,center, lod, index:i}), 'utf8');
